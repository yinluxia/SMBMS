...
<!--时间-->
 ...
 <section class="publicMian">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                  <li><a href="${pageContext.request.contextPath }/statics/jsp/bill.do?method=query">订单管理</a></li>
	              ...
	              <li><a href="${pageContext.request.contextPath }/statics/jsp/pwdmodify.jsp">密码修改</a></li>
	              <li><a href="${pageContext.request.contextPath }/statics/jsp/logout.do">退出系统</a></li>
             </ul>
         </nav>
     </div>
